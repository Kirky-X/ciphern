...
impl super::super::GpuKernel for OpenclAesKernel {
    ...
    fn execute_aes_gcm_encrypt(
        ...
        Err(CryptoError::HardwareAccelerationUnavailable(
            "OpenCL AES kernel not available".into(),
        ))
    }
...
impl Default for OpenclAesKernel {
    fn default() -> Self {
        Self::new()
    }
}
